# Generated by Powerlevel10k configuration wizard on 2025-09-02 at 01:57 UTC.
...
# sharp tails, 2 lines, disconnected, full frame, lightest-ornaments, sparse, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    context                 # user@hostname (moved from right)
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    bluegreen               # blue-green deployment status (high priority)
    ...
    # context               # user@hostname (moved to left)
    ...
    # time                  # current time (moved to left)
    # =========================[ Line #2 ]=========================
    newline
  ...
  function prompt_bluegreen() {
    ...
    # Show branch with text labels and clear separators
    case "$branch_name" in
      master|main)
        p10k segment -f 15 -b 4 -t "MAIN: $display_text"  # Main/master branch with separator
        ;;
      local|custom|unknown)
        p10k segment -f 8 -b 0 -t "LOCAL: $display_text"  # Local development with separator
        ;;
      *)
        p10k segment -f 33 -b 4 -t "BRANCH: $display_text"  # Feature branches with separator
        ;;
    esac
  }
